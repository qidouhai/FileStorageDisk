...
func main() {
	username := "admin"
	token := "f2bf8acccd7e9e48b76d3d5117b09c7962d8c474"
	filehash := "3f7fb3f2657593c9ec04b7469d0ddd96e4699cb8"
	...
	// 3. 请求分块上传接口
	// filename := "/home/cenjw/gowork/src/FileStorageDisk/data/pkg/head-first-go.pdf"
	filename := "/data/pkg/head-first-go.pdf"
